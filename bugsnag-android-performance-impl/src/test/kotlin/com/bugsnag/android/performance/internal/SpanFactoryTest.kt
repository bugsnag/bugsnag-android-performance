...
class SpanFactoryTest {
    ...
    private val spanMetricsWithoutRendering =
        SpanMetrics(rendering = false, cpu = true, memory = true)
            ...
            SpanFactory(
                ...
                metricsContainer =
                    TestMetricsContainer(
                        ...
                        frames = FramerateMetricsSource(mock()),
                    ),
            )
    ...
    fun testRenderMetricsOptions() {
        ...
        assertNull(
            "SpanOptions.setFirstClass(false) should not have rendering metrics by default",
            metrics,
        )
