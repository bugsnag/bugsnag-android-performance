...
class ImmutableConfigTest {
    ...
    fun copyFromPerformanceConfiguration() {
        ...
        val immutableConfig =
            ImmutableConfig(
                perfConfig,
                PluginManager(emptyList(), TestTimeoutExecutor()),
            )
    ...
    fun addRemoveSpanEndCallbacks() {
        ...
        assertSame(spanEndCallback1, perfConfig.spanEndCallbacks.elementAt(0))
        assertSame(spanEndCallback3, perfConfig.spanEndCallbacks.elementAt(1))
    }
