...
class SpanTrackerTest {
    ...
    private fun createSpan(name: String): SpanImpl {
        return spanFactory.newSpan(name, endTime = null, processor = NoopSpanProcessor.INSTANCE)
    }

    private fun createSpan(): SpanImpl {
        return spanFactory.newSpan(endTime = null, processor = NoopSpanProcessor.INSTANCE)
    }
