...
public open class BatchingSpanProcessor : SpanProcessor {
     ...
     */
    public val currentBatchSize: Int get() = batchSize.get()
     ...
     */
    public fun takeBatch(): Collection<SpanImpl> {
     ...
     */
    public fun addToBatch(span: SpanImpl): Int {
        while (true) {
